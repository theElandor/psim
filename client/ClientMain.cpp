...
SDL_Rect get_main_area(int window_h, int window_w, int console_h, int input_h){
   /*
...
SDL_Rect get_upload_button_area(SDL_Rect main_area){
  SDL_Rect button_area;
  button_area.x = main_area.w - BUTTON_WIDTH - BUTTON_MARGIN;
  button_area.y = main_area.h + BUTTON_AREA_H / 2 + BUTTON_MARGIN;
